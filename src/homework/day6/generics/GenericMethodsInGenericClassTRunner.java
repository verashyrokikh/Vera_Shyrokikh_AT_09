...
public class GenericMethodsInGenericClassTRunner {
    public static void main(String[] args) {
        ...
        System.out.println(newInteger.genericMethodTwoGenArgs(33, 87));
        ...
        System.out.println(newDouble.genericMethodTwoGenArgs(5.3, 4.3));
        ...
        System.out.println(copter.genericMethodTwoGenArgs(new Copter(223, "Mi8 Flyable"), new Copter(223, "Mi8 Copter")));
        ...
        System.out.println(plane.genericMethodTwoGenArgs(new Plane(3452, "Boeing 837 Flyable"), new Plane(3452, "Boeing 837 Aircraft")));
        ...
        System.out.println(rocket.genericMethodTwoGenArgs(new Rocket(7623, "Super Heavy Flyable"), new Rocket(7623, "Super Heavy Aircraft")));
        ...
        System.out.println(car.genericMethodTwoGenArgs(new Car(223, "Lada Vehicle"), new Car(223, "Lada Car")));
        ...
        System.out.println(moped.genericMethodTwoGenArgs(new Moped(3452, "Honda EM1 837 Rideable"), new Moped(3452, "Honda EM1 837 Vehicle")));
        ...
        System.out.println(motorbike.genericMethodTwoGenArgs(new Motorbike(7623, "Suzuki GSX-R1000 Rideable"), new Motorbike(7623, "Suzuki GSX-R1000 Vehicle")));
        ...
        System.out.println(bottle.genericMethodTwoGenArgs(new Bottle(23, "Glass"), new Bottle(4, "Plastic")));
        ...
        System.out.println(can.genericMethodTwoGenArgs(new Can(82, "Small"), new Can(54, "Big")));
        ...
        System.out.println(mug.genericMethodTwoGenArgs(new Mug(3, "small"), new Mug(5, "large")));
        ...
        System.out.println(beetle.genericMethodTwoGenArgs(new Beetle(43, "Christmas Crawlable"), new Beetle(43, "Christmas Insect")));
        ...
        System.out.println(carrot.genericMethodTwoGenArgs(new Carrot(1, "Purple"), new Carrot(1, "Yellow")));
        ...
        System.out.println(chamomile.genericMethodTwoGenArgs(new Chamomile(1, "Big flowers"), new Chamomile(1, "Small flowers")));
        ...
        System.out.println(crocodile.genericMethodTwoGenArgs(new Crocodile(1723, "Neel Crawlable"), new Crocodile(1723, "Neel Vertebrata")));
        ...
        System.out.println(fly.genericMethodTwoGenArgs(new Fly(23, "Domestica Flyable"), new Fly(23, "Domestica Insect")));
        ...
        System.out.println(maylily.genericMethodTwoGenArgs(new Maylily(2, "Forest"), new Maylily(2, "Garden")));
        ...
        System.out.println(mosquito.genericMethodTwoGenArgs(new Mosquito(12, "Vulgaris Flyable"), new Mosquito(12, "Vulgaris Insect")));
        ...
        System.out.println(pigeon.genericMethodTwoGenArgs(new Pigeon(4, "City grey"), new Pigeon(4, "City white")));
        ...
        System.out.println(potato.genericMethodTwoGenArgs(new Potato(1, "Red"), new Potato(1, "White")));
        ...
        System.out.println(radish.genericMethodTwoGenArgs(new Radish(2, "Pink-white"), new Radish(2, "Red")));
        ...
        System.out.println(raven.genericMethodTwoGenArgs(new Raven(7, "Smart"), new Raven(7, "Talkative")));
        ...
        System.out.println(rose.genericMethodTwoGenArgs(new Rose(3, "Pink"), new Rose(3, "Yellow")));
        ...
        System.out.println(diesel.genericMethodTwoGenArgs(new Diesel(6), new Diesel(8)));
        ...
        System.out.println(petrol.genericMethodTwoGenArgs(new Petrol(9), new Petrol(8)));
        ...
        System.out.println(water.genericMethodTwoGenArgs(new Water(5), new Water(8)));
