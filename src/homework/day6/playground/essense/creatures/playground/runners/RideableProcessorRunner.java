...
import homework.day6.playground.essense.creatures.playground.processors.RideableProcessor;
...
public class RideableProcessorRunner {
    public static void main(String[] args) {
        ...
        rideableProcessor.runRideable(vehicleCar,"nowhere");
        rideableProcessor.runRideable(vehicleMoped,"anywhere");
    }
}
