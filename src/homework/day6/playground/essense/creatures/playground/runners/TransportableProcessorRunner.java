package homework.day6.playground.essense.creatures.playground.runners;
...
import homework.day6.playground.essense.creatures.playground.essense.craft.air.Aircraft;
...
import homework.day6.playground.essense.creatures.playground.essense.craft.field.Vehicle;
import homework.day6.playground.essense.creatures.playground.processors.TransportableProcessor;
...
//      в сигнатуре метода runTransportable указан, что тип объекта должен быть Transportable, а не flyable или rideable
        ...
        transportableProcessor.runTransportable(aRocket, 93, 7);
    }
}
